...
const features = [
  ...
  {
    icon: MessageSquare,
    title: "Smart shared context",
    description:
      "Agents communicate through shared markdown. Differential filtering gives each agent only the context they need — 30-70% token savings over broadcasting everything.",
  },
  {
    icon: RotateCcw,
    title: "Auto-cycle mode",
    description:
      "Run N cycles unattended. Token budgets, smart task decomposition, prompt compression, and usage monitoring keep costs predictable.",
  },
  {
    icon: Sparkles,
    title: "Pixel Agents",
    description:
      "Watch your agents work in a pixel art office. Real-time visualization powered by JSONL events — see who's building what, live.",
  },
];
