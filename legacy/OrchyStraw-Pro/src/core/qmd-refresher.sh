#!/usr/bin/env bash
# =============================================================================
# qmd-refresher.sh — Auto-refresh QMD index each cycle (#37)
#
...
# auto-agent.sh (lines 703-716) with proper state tracking.
#
# Usage:
...
#
# Looks for a .qmd/ directory in the current project root, which qmd creates
