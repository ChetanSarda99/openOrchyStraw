# OrchyStraw — Gemini Instructions
...
## Priority
1. Landing page — public site inspired by conductor.build
2. Tauri dashboard — log viewer, agent status, config editor
3. Pixel Agents — pixel art office visualization
