...
const steps = [
  ...
  },
  {
    ...
    description:
      "One command. Agents read their prompts, do their work, and write to shared context. Token-efficient filtering means each agent only sees what's relevant. No conflicts — file ownership keeps everyone in their lane.",
  },
  {
    number: "03",
    icon: CheckCircle,
    ...
    description:
      "PM agent coordinates. QA reviews. You check the diff and merge. Auto-cycle mode runs multiple cycles unattended with smart scheduling and token budgets.",
  },
];
